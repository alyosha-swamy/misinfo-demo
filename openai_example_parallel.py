                ...
                if (
                    ...
                    asyncio.create_task(
                        next_request.call_api(
                            ...
                            results=results,  # Pass the results list to the call_api method
...
class APIRequest:
    ...
    async def call_api(
        ...
        results: list,  # Add this parameter
        ...
        if error:
            ...
            if self.attempts_left:
                ...
                results.append([example_id, copied_request, [str(e) for e in self.result]])  # Append the result to the list
                status_tracker.num_tasks_in_progress -= 1
                status_tracker.num_tasks_failed += 1
        else:
            results.append([example_id, copied_request, response])  # Append the result to the list
            status_tracker.num_tasks_in_progress -= 1
